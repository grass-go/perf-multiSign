...
do  
    ...
    addrArray=(${line//,/ })
    echo ${addrArray[0]}
    sqlstr="update multi_tx set threshold=2, current_weight=1, state=0, expire_time='$ts', signers='[{\"u\":\"${addrArray[0]}\",\"w\":1,\"is\":0,\"st\":1626661786000},{\"u\":\"TWtWEbY47eZE3TQfaAa7Vj53LV24hki1pf\",\"w\":1,\"is\":0,\"st\":1626661786000}]' where id=$count"
    echo ${sqlstr}
